...
public class attendanceToPdf {

    public attendanceToPdf(){
        main(null);
    }
    ...
    public static void main (String [] args){
        ...
        //File sourceFile = new File ("C:\\Temp\\attendanceRecord.txt") ;
        //File destFile = new File ("C:\\Temp\\attendancereport.pdf") ;

        File sourceFile = new File ("C:\\reports\\Files\\attendanceRecord.txt") ;
        File destFile = new File ("C:\\reports\\Files\\attendanceReport.pdf") ;
        try {
